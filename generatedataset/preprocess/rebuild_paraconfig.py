...
path_para_info = {
    'modified_inputfile' : os.path.dirname(datafilepath)+'/modified_inputfile',
    'tzfile_dic_path_dir' : os.path.dirname(datafilepath)+'/modify_tzfile',
    'modify_npz_file_path_dir' : os.path.dirname(datafilepath)+'/modify_npz_file',
    'seis_dat_dic_path' : datafilepath+'/seis_dat',
    'rebuild_seis_data_dir' : datafilepath+'/seis_rebuild_data',
    'show_dic_path' : datafilepath+'/show',
}
...
add_noise_or_not_para = True

mean_value_para = 0
sigma_value_para = 0.15

random_sta_or_not_para = True
use_sta_num_para = 31
