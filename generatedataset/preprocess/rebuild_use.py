...
for i in range(len(tzfiles)):
    ...
    modify_model_path = os.path.dirname(os.getcwd().replace('generatedata_v20250807','data/generatedata_v20250807'))+'/modified_modelfile/modify_model'+t_echo+'.dat'
    modify_model_dic = get_modify_model_data(modify_model_path)

    pic_path = path_para_info['show_dic_path'] + '/shpw_vp_seis' + t_echo + '.png'
    draw_rebuild_data(
    vel_base_dic,
    modify_model_dic,
    locdata,
