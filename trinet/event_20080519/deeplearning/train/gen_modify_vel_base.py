...
class modify_vel_base_model():
    ...
    def modify_velocity(
        ...
        return self.vel_base_model_dict_modify_velocity, self.v_ran_change, self.changed_depth_no
...
if __name__ == '__main__':
    ...
    vel_model_info_dic = {
        ...
        'interpolation_start_depth' : 560.0,
        'interpolation_end_depth' : 800.0,
        'interpolation_each_layer_depth' : 30.0,
