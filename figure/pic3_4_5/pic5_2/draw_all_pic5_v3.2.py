...
file_name = ['dl0_0_train0_0_testset_sta7','dl0_0_train0_0_testset_sta15', 'dl0_0_train0_0_testset_sta23', 'dl0_0_train0_0', 'dl0_0_train0_0_testset_sta39']

draw_val_file_path = [
    all_val_logs_save_dir_path+'/dl0_0_train0_0_testset_sta39.dat',
    all_val_logs_save_dir_path+'/dl0_0_train0_0_testset_sta23.dat',
    all_val_logs_save_dir_path+'/dl0_0_train0_0.dat',
    all_val_logs_save_dir_path+'/dl0_0_train0_0_testset_sta15.dat',
    all_val_logs_save_dir_path+'/dl0_0_train0_0_testset_sta7.dat',
]
draw_val_corr_file_path = [
    all_corr_logs_save_dir_path+'/dl0_0_train0_0_testset_sta39.txt',
    all_corr_logs_save_dir_path+'/dl0_0_train0_0_testset_sta23.txt',
    all_corr_logs_save_dir_path+'/dl0_0_train0_0.txt',
    all_corr_logs_save_dir_path+'/dl0_0_train0_0_testset_sta15.txt',
    all_corr_logs_save_dir_path+'/dl0_0_train0_0_testset_sta7.txt',
]
draw_legend_name = {
    'dl0_0_train0_0':'31 (Test Set)',
    'dl0_0_train0_0_testset_sta23':'23',
    'dl0_0_train0_0_testset_sta39':'39',
    'dl0_0_train0_0_testset_sta15':'15',
    'dl0_0_train0_0_testset_sta7':'7',
}
...
ax4.set_ylabel('CC')
ax4.set_ylim(0.35, 1.01)
ax4.set_yticks([0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0])
...
fig.savefig('pic5_2_v3.2.svg')
# fig.savefig('pic5_2_v3.2.jpg')
