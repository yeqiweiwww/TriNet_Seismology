...
file_name = ['dl0_0_train4_0','dl0_0_train1_0','dl0_0_train2_0','dl0_0_train3_0','dl0_0_train0_0']

draw_train_file_path = [
    all_train_logs_save_dir_path+'/dl0_0_train1_0.txt',
    all_train_logs_save_dir_path+'/dl0_0_train2_0.txt',
    all_train_logs_save_dir_path+'/dl0_0_train3_0.txt',
    all_train_logs_save_dir_path+'/dl0_0_train4_0.txt',
    all_train_logs_save_dir_path+'/dl0_0_train0_0.txt',
    ]
draw_val_file_path = [
    all_val_logs_save_dir_path+'/dl0_0_train1_0.dat',
    all_val_logs_save_dir_path+'/dl0_0_train2_0.dat',
    all_val_logs_save_dir_path+'/dl0_0_train3_0.dat',
    all_val_logs_save_dir_path+'/dl0_0_train4_0.dat',
    all_val_logs_save_dir_path+'/dl0_0_train0_0.dat',
]
draw_val_corr_file_path = [
    all_corr_logs_save_dir_path+'/dl0_0_train1_0.txt',
    all_corr_logs_save_dir_path+'/dl0_0_train2_0.txt',
    all_corr_logs_save_dir_path+'/dl0_0_train3_0.txt',
    all_corr_logs_save_dir_path+'/dl0_0_train4_0.txt',
    all_corr_logs_save_dir_path+'/dl0_0_train0_0.txt',
]
draw_legend_name = {
    'dl0_0_train1_0':'DenseNet',
    'dl0_0_train2_0':'ResNet',
    'dl0_0_train3_0':'VGGNet',
    'dl0_0_train4_0':'VIT',
    'dl0_0_train0_0':'UNet',
}
...
color_set = {
    ...
    'dl0_0_train2_0':(237/255, 163/255, 73/255),
    'dl0_0_train3_0':(115/255, 182/255, 104/255),
    'dl0_0_train4_0':(99/255, 193/255, 212/255),
    'dl0_0_train1_0':(73/255, 124/255, 186/255),
}
# color_set = {
#     'dl1_0_train1_2':'#0c8fc7',
#     'dl1_0_train1_5':'#72b043',
#     'dl1_0_train1_4':'#f8cc1b',
#     'dl1_0_train1_3':'#f37324',
#     'dl1_0_train1_0':'#e12729',
# }
...
ax4.set_ylabel('CC')
ax4.set_ylim(0.28,1.01)
ax4.set_yticks([0.3,0.5,0.7,0.9])
...
ax3.set_ylim(0.08,1.01)
ax3.set_yticks([0.1,0.3,0.5,0.7,0.9])
ax3.set_xticks(positions,ax3_label)

ax3.set_ylabel('Loss')
ax3.set_xlabel('Feature Extractor Models')
...
fig.savefig('pic3_v3.2.svg')
# fig.savefig('pic3_v3.2.jpg')
