...
real_pre_rebuild_file_path = '../d/rerundata/20090716/rebuild_vp_seis_real_pre.dat'
model_li_rebuild_file_path = '../../pic7/d/oridata/li/rebuild_vp_seis_model_li_20080519.dat'
real_rebuild_file_path = '../d/oridata/20090716/rebuild_data_real_v2.0_refine_use.dat'
...
model_pre_model_path = '../d/rerundata/20090716/modify_model_real_pre.dat'
model_pre_model_up_path = '../d/rerundata/20090716/all_up_use.dat'
model_pre_model_low_path = '../d/rerundata/20090716/all_low_use.dat'
...
handles = [
    ...
    Line2D([0], [0], color=pre_lin_color, linestyle=pre_lin_type, linewidth=pre_lin_model_wid, dashes=pre_lin_dashes, label='TriNet_2009'),
...
rectangle1 = patches.Rectangle((38.5, 20.5), 5, 4, facecolor='none', edgecolor=r1edgecolor, linewidth=r1linewidth, linestyle='--', zorder=5)
rectangle2 = patches.Rectangle((41, 15), 5, 3.7, facecolor='none', edgecolor=r2edgecolor, linewidth=r2linewidth, linestyle='--', zorder=5)

ax2.add_patch(rectangle1)
ax2.add_patch(rectangle2)

ax2.text(44,24,'R1', fontsize=12, bbox=dict(facecolor='white', edgecolor='black', alpha=0.8, boxstyle='round,pad=0.1'))
ax2.text(46.7,18,'R2', fontsize=12, bbox=dict(facecolor='white', edgecolor='black', alpha=0.8, boxstyle='round,pad=0.1'))


ax2.text(28,29,'D',fontsize=10)
ax2.text(44.5,14.3,'C',fontsize=10)
...
ax3.text(44,24,'R1', fontsize=12, bbox=dict(facecolor='white', edgecolor='black', alpha=0.8, boxstyle='round,pad=0.1'))
ax3.text(46.7,18,'R2', fontsize=12, bbox=dict(facecolor='white', edgecolor='black', alpha=0.8, boxstyle='round,pad=0.1'))

ax3.text(28,29,'D',fontsize=10)
ax3.text(44.5,14.3,'C',fontsize=10)
...
handles = [
    Line2D([0], [0], color=pre_lin_color, linestyle=pre_lin_type, linewidth=pre_lin_seis_wid, dashes=pre_lin_dashes, label='TriNet_2009'),
    Line2D([0], [0], color=real_lin_color, linestyle=real_lin_type, linewidth=real_lin_wid, dashes=real_lin_dashes, label='Observation')
]
...
fig.savefig('pic7_2009_v2.1.svg')
# fig.savefig('pic7_2009_v2.1.jpg')
plt.close(fig=fig)