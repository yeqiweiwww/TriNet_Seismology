...
rebuild_real_reduce_time, rebuild_real_reduce_seis, _, _ = get_rebuild_data_real('../d/oridata/20080519/rebuild_data_real_v2.0_refine_use.dat')
rebuild_pre_rerun_reduce_time, rebuild_pre_rerun_reduce_seis, _, _ = get_rebuild_data_rebuild('../d/rerundata/20080519/rebuild_vp_seis_real_pre.dat')
