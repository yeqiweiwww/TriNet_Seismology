...
modi_vel_file_path = './modify_model_idx000.dat'

rebuild_seis_file_path = './rebuild_vp_seis_idx000.dat'
non_rebuild_seis_file_path = './rebuild_vp_seis_idx000_non.dat'
...
##########################################################
pre_vel_file_path = './pre_model_idx001.dat'

input_seis_file_path = './rebuild_vp_seis_idx001.dat'
pre_rebuild_seis_file_path = './rebuild_vp_seis_idx001_re.dat'
...
fig.tight_layout()
fig.savefig('stadis001.svg')

##########################################################
pre_vel_file_path = './pre_model_idx002.dat'

input_seis_file_path = './rebuild_vp_seis_idx002.dat'
pre_rebuild_seis_file_path = './rebuild_vp_seis_idx002_re.dat'
...
fig.tight_layout()
fig.savefig('stadis002.svg')

##########################################################
pre_vel_file_path = './pre_model_idx003.dat'

input_seis_file_path = './rebuild_vp_seis_idx003.dat'
pre_rebuild_seis_file_path = './rebuild_vp_seis_idx003_re.dat'
...
fig.tight_layout()
fig.savefig('stadis003.svg')

##########################################################
pre_vel_file_path = './pre_model_idx004.dat'

input_seis_file_path = './rebuild_vp_seis_idx004.dat'
pre_rebuild_seis_file_path = './rebuild_vp_seis_idx004_re.dat'
...
fig.tight_layout()
fig.savefig('stadis004.svg')

##########################################################
pre_vel_file_path = './pre_model_idx005.dat'

input_seis_file_path = './rebuild_vp_seis_idx005.dat'
pre_rebuild_seis_file_path = './rebuild_vp_seis_idx005_re.dat'
...
fig.tight_layout()
fig.savefig('stadis005.svg')

##########################################################
pre_vel_file_path = './pre_model_idx000.dat'

input_seis_file_path = './rebuild_vp_seis_idx000.dat'
pre_rebuild_seis_file_path = './rebuild_vp_seis_idx000_re.dat'
...
fig.text(0.02, 0.96, '(f)')
fig.tight_layout()
fig.savefig('stadis000.svg')