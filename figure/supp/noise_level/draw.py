...
modi_vel_file_path = './modify_model_noise015.dat'

rebuild_seis_file_path = './rebuild_vp_seis_noise015.dat'
non_rebuild_seis_file_path = './rebuild_vp_seis_noise015_non.dat'
...
##########################################################
pre_vel_file_path = './pre_model_noise005.dat'

input_seis_file_path = './rebuild_vp_seis_noise005.dat'
pre_rebuild_seis_file_path = './rebuild_vp_seis_noise005_re.dat'
...
ax1.text(48, 28.5, r'$\sigma$:'+'\n005', fontsize=12, bbox=dict(facecolor='white', edgecolor='black', alpha=0.8, boxstyle='round,pad=0.5'))
...
fig.tight_layout()
fig.savefig('noise005.svg')

##########################################################
pre_vel_file_path = './pre_model_noise010.dat'

input_seis_file_path = './rebuild_vp_seis_noise010.dat'
pre_rebuild_seis_file_path = './rebuild_vp_seis_noise010_re.dat'
...
ax1.set_ylabel('Distance (deg)')
ax1.set_xlabel('t-'+'Distance*'+str(reduction_v_para)+' (s)')
ax1.text(48, 28.5, r'$\sigma$:'+'\n010', fontsize=12, bbox=dict(facecolor='white', edgecolor='black', alpha=0.8, boxstyle='round,pad=0.5'))
...
fig.tight_layout()
fig.savefig('noise010.svg')

##########################################################
pre_vel_file_path = './pre_model_noise015.dat'

input_seis_file_path = './rebuild_vp_seis_noise015.dat'
pre_rebuild_seis_file_path = './rebuild_vp_seis_noise015_re.dat'
...
ax1.set_ylabel('Distance (deg)')
ax1.set_xlabel('t-'+'Distance*'+str(reduction_v_para)+' (s)')
ax1.text(48, 28.5, r'$\sigma$:'+'\n015', fontsize=12, bbox=dict(facecolor='white', edgecolor='black', alpha=0.8, boxstyle='round,pad=0.5'))
...
fig.tight_layout()
fig.savefig('noise015.svg')

##########################################################
pre_vel_file_path = './pre_model_noise020.dat'

input_seis_file_path = './rebuild_vp_seis_noise020.dat'
pre_rebuild_seis_file_path = './rebuild_vp_seis_noise020_re.dat'
...
ax1.set_ylabel('Distance (deg)')
ax1.set_xlabel('t-'+'Distance*'+str(reduction_v_para)+' (s)')
ax1.text(48, 28.5, r'$\sigma$:'+'\n020', fontsize=12, bbox=dict(facecolor='white', edgecolor='black', alpha=0.8, boxstyle='round,pad=0.5'))
...
fig.tight_layout()
fig.savefig('noise020.svg')

##########################################################
pre_vel_file_path = './pre_model_noise025.dat'

input_seis_file_path = './rebuild_vp_seis_noise025.dat'
pre_rebuild_seis_file_path = './rebuild_vp_seis_noise025_re.dat'
...
ax1.set_ylabel('Distance (deg)')
ax1.set_xlabel('t-'+'Distance*'+str(reduction_v_para)+' (s)')
ax1.text(48, 28.5, r'$\sigma$:'+'\n025', fontsize=12, bbox=dict(facecolor='white', edgecolor='black', alpha=0.8, boxstyle='round,pad=0.5'))
