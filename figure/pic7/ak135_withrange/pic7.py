...
ak_lin_type = '-'
ak_lin_color = (66/255, 133/255, 244/255)
ak_lin_model_wid = 1.3
ak_lin_seis_wid = 1
ak_lin_dashes = []
ak_pre_rerun_lin_type = '-'
ak_pre_rerun_lin_color = (219/255, 68/255, 55/255)
ak_pre_rerun_lin_color_up_low = (244/255, 180/255, 0/255)
ak_pre_rerun_lin_model_wid = 1.3
ak_pre_rerun_lin_seis_wid = 1
ak_pre_rerun_lin_dashes = []
...
ax1.plot(draw_ak135_pre_rerun_vp_up, draw_ak135_pre_rerun_depth_up, color=ak_pre_rerun_lin_color_up_low, linestyle=ak_pre_rerun_lin_type, dashes=ak_pre_rerun_lin_dashes, linewidth=ak_pre_rerun_lin_model_wid, label='AK135_Pre', zorder=1)
ax1.plot(draw_ak135_pre_rerun_vp_low, draw_ak135_pre_rerun_depth_low, color=ak_pre_rerun_lin_color_up_low, linestyle=ak_pre_rerun_lin_type, dashes=ak_pre_rerun_lin_dashes, linewidth=ak_pre_rerun_lin_model_wid, label='AK135_Pre', zorder=1)
ax1.fill_betweenx(draw_ak135_pre_rerun_depth_up, draw_ak135_pre_rerun_vp_up, draw_ak135_pre_rerun_vp_low, color=ak_pre_rerun_lin_color_up_low, alpha=0.3, zorder=1)
ax1.plot(draw_ak135_vp, draw_ak135_depth, color=ak_lin_color, linestyle=ak_lin_type, dashes=ak_lin_dashes, linewidth=ak_lin_model_wid, label='AK135', zorder=2)
ax1.plot(draw_ak135_pre_rerun_vp, draw_ak135_pre_rerun_depth, color=ak_pre_rerun_lin_color, linestyle=ak_pre_rerun_lin_type, dashes=ak_pre_rerun_lin_dashes, linewidth=ak_pre_rerun_lin_model_wid, label='AK135_Pre', zorder=3)

# ax1.legend(loc='lower left')

handles = [
    Line2D([0], [0], color=ak_lin_color, linestyle=ak_lin_type, linewidth=ak_lin_model_wid, dashes=ak_lin_dashes, label='AK135'),
    Line2D([0], [0], color=ak_pre_rerun_lin_color, linestyle=ak_pre_rerun_lin_type, linewidth=ak_pre_rerun_lin_model_wid, dashes=ak_pre_rerun_lin_dashes, label='AK135_Pre'),
    Line2D([0], [0], color=ak_pre_rerun_lin_color_up_low, linestyle=ak_pre_rerun_lin_type, linewidth=ak_pre_rerun_lin_model_wid, dashes=ak_pre_rerun_lin_dashes, label='Pre_Range'),
]
...
ax1.text(9.8, 405, 'Loss: '+f"{all_loss_ak:.3f}",fontsize=10)
# ax1.set_xticks()
ax1.invert_yaxis()
...
for i in range(len(ak135_pro_time)):
    if i == 0:
        ax2.plot(ak135_pro_time[i], draw_ak135_pro_vp_data[i], color=ak_lin_color, label='AK135', linestyle=ak_lin_type, dashes=ak_lin_dashes, linewidth=ak_lin_seis_wid)
    else:
        ax2.plot(ak135_pro_time[i], draw_ak135_pro_vp_data[i], color=ak_lin_color, dashes=ak_lin_dashes, linestyle=ak_lin_type, linewidth=ak_lin_seis_wid)

for i in range(len(ak135_pre_rerun_pro_time)):
    if i == 0:
        ax2.plot(ak135_pre_rerun_pro_time[i], draw_ak135_pre_rerun_pro_vp_data[i], color=ak_pre_rerun_lin_color, label='AK135_Pre', linestyle=ak_pre_rerun_lin_type, dashes=ak_pre_rerun_lin_dashes, linewidth=ak_pre_rerun_lin_seis_wid)
    else:
        ax2.plot(ak135_pre_rerun_pro_time[i], draw_ak135_pre_rerun_pro_vp_data[i], color=ak_pre_rerun_lin_color, dashes=ak_pre_rerun_lin_dashes, linestyle=ak_pre_rerun_lin_type, linewidth=ak_pre_rerun_lin_seis_wid)
...
handles = [
    Line2D([0], [0], color=ak_lin_color, linestyle=ak_lin_type, linewidth=ak_lin_seis_wid, dashes=ak_lin_dashes, label='AK135'),
    Line2D([0], [0], color=ak_pre_rerun_lin_color, linestyle=ak_pre_rerun_lin_type, linewidth=ak_pre_rerun_lin_seis_wid, dashes=ak_pre_rerun_lin_dashes, label='TriNet_AK135'),
    Line2D([0], [0], color=ak_pre_rerun_lin_color_up_low, linestyle=ak_pre_rerun_lin_type, linewidth=ak_pre_rerun_lin_seis_wid, dashes=ak_pre_rerun_lin_dashes, label='Pre_Range'),
]
...
ax2.text(43, 30, 'CC: '+ak135_corr,fontsize=10)
...
fig.savefig('ak135_v2.0.svg')
# fig.savefig('pic8_ak135_v2.0.jpg')
plt.close(fig=fig)