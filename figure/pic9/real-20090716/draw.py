...
ax1.text(43, 29.5, 'Rawdata', bbox=dict(facecolor='white', edgecolor='black', alpha=0.8, boxstyle='round,pad=0.5'))
...
handles = [
    ...
    Line2D([0], [0], color=pre_new_lin_color, linestyle=pre_new_lin_type, linewidth=pre_new_lin_seis_wid, dashes=pre_new_lin_dashes, label='Rawdata'),
]
...
fig.tight_layout()
fig.savefig('real_20090716_ori.svg')
