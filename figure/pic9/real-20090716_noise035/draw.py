...
pre_ori_vel_file_path = '../real-20090716/pre_vel.dat'

obs_rebuild_seis_file_path = '../real-20090716/rebuild_real.dat'
...
ax1.text(48, 28.5, r'$\sigma$:'+'\n0.35', bbox=dict(facecolor='white', edgecolor='black', alpha=0.8, boxstyle='round,pad=0.5'))

ax1.text(19, 29, '20090716', bbox=dict(facecolor='white', edgecolor='black', alpha=0.8, boxstyle='round,pad=0.5'))
...
handles = [
    ...
    Line2D([0], [0], color=pre_new_lin_color, linestyle=pre_new_lin_type, linewidth=pre_new_lin_seis_wid, dashes=pre_new_lin_dashes, label='Noise035'),
]
...
fig.tight_layout()
fig.savefig('real_20090716_noise035.svg')
